...
const handleGoogleAuth = async () => {
  try {
    ...
    if (!data) throw new Error('No se pudo iniciar sesión con Google')
      ...
      <div class="mt-6 sm:mt-8">
        ...
        <div class="relative mt-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="bg-white dark:bg-gray-800 px-2 text-gray-500 dark:text-gray-400">O usa tu correo</span>
          </div>
        </div>
